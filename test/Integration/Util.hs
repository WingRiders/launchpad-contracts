...
rewardsFoldConfig lCfg =
  R.RewardsFoldConfig
    ...
    , finalWrProjectTokensHolderValidatorHash = PTHF.projectTokensHolderScriptValidatorHash (finalTokensHolderConfig lCfg)
    , finalSundaeProjectTokensHolderValidatorHash = PTHF.projectTokensHolderScriptValidatorHash (finalTokensHolderConfig lCfg)
